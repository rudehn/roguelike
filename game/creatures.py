...
Creatures: Final = (
    ...
    Creature("troll", ord("T"), (0, 127, 0), 16, "1d6", 0, 50, spawn_weight=((6, 5), (7, 15), (8, 30)),
             traits=(RacialTrait("lesser_regeneration", TraitTarget.SELF, TraitActivation.ON_CREATE),)),
    Creature("troll_cave", ord("S"), (0, 127, 0), 20, "0d1", 0, 75, spawn_weight=((6, 10), (8, 20), (12, 10), (15, 0)),
             ai=AIBuilder(SpawnerAI, {"spawned_entity_name": "troll", "spawn_rate": 20})),
    Creature("acid_slime", ord("a"), (0, 200, 0), 8, "1d4", 0, 10, damage_type=DamageType.POISON,
    ...
    Creature("mama_acid_slime", ord("S"), (0, 200, 0), 20, "0d1", 0, 75, spawn_weight=((8, 5), (10, 10), (12, 15), (18, 0)),
             ai=AIBuilder(SpawnerAI, {"spawned_entity_name": "acid_slime", "spawn_rate": 10})),
    Creature("dragon", ord("D"), (200, 50, 50), 40, "2d8", 4, 250, damage_type=DamageType.FIRE, resistances=(DamageResistance(DamageType.FIRE, ResistanceLevel.IMMUNE),) )
)
